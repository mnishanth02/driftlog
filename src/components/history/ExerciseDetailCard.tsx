...
export function ExerciseDetailCard({ exercise }: ExerciseDetailCardProps) {
  ...
  return (
    <View className="bg-light-surface dark:bg-dark-surface border border-light-border-light dark:border-dark-border-medium rounded-xl px-3 py-2 mb-1.5 flex-row items-center justify-between">
      ...
      <View className="bg-success/10 px-2 py-0.5 rounded-full">
        <Text className="text-[10px] font-bold text-success capitalize">Completed</Text>
      </View>
    </View>
  );
}
