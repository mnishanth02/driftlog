...
export function SessionMetadata({ date, startTime, endTime, planTitle }: SessionMetadataProps) {
  ...
  return (
    <View className="bg-light-surface dark:bg-dark-surface border border-light-border-light dark:border-dark-border-medium rounded-2xl p-4 mb-4">
      ...
      <View className="flex-row items-center justify-between mb-2">
        ...
        { duration !== null && (
          <View className="bg-primary-500/10 dark:bg-dark-primary/10 rounded-lg px-2.5 py-1">
            <Text className="text-primary-500 dark:text-dark-primary text-xs font-bold">
      ...
      <View className="flex-row items-center flex-wrap gap-y-1">
        <View className="flex-row items-center mr-4 gap-1.5">
          <Ionicons
            name="time-outline"
            size={ 14 }
      ...
      { isDurationEstimated && (
        <View className="mt-2 pt-2 border-t border-light-border-light dark:border-dark-border-medium flex-row items-center gap-2">
          <Ionicons
            ...
            accessible={ false }
          />
          <Text className="text-[10px] text-warning flex-1 italic">
