  ...
  return (
    <View className="flex-1 bg-light-bg-primary dark:bg-dark-bg-primary">
      ...
      >
        ...
        {/* Theme Section */}
        <View className="mb-6 bg-light-surface dark:bg-dark-surface rounded-2xl border p-5 border-light-border-light dark:border-dark-border-medium">
        ...
        <View className="mb-8 bg-light-surface dark:bg-dark-surface rounded-2xl border p-5 border-light-border-light dark:border-dark-border-medium">
